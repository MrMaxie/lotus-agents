...
const commandMessages: Record<ProjectCommand, string> = {
  install:
    "Install routing is ready. Full LotusAgents artifact installation belongs to the broader MAX-72 installer work.",
  update:
    "Update routing is ready. Existing-state update semantics belong to the broader MAX-72 installer work.",
  remove:
    "Remove routing is ready. Managed artifact removal belongs to the broader MAX-72 installer work.",
  doctor:
    "Doctor routing is ready. Semantic health checks and repair guidance belong to the broader MAX-72 validator work.",
  validate:
    "Validate routing is ready. Zod-backed managed-file validation belongs to the broader MAX-72 validator work."
};
...
async function renderCommandPlan(
  command: ProjectCommand,
