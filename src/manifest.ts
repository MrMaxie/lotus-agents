...
export enum ManagedArtifactType {
  ...
  LocalWorkflowNotes = 'local-workflow-notes',
  ProjectWorkflowConfig = 'project-workflow-config',
...
const workflowProcedures = ['task-source-routing', 'workflow-config', 'workflow-hygiene'];
...
const rawLotusManifest = {
  ...
  artifacts: [
    ...
    createArtifact({
      path: '.local/WORKFLOW.md',
      scope: ManagedArtifactScope.Local,
      kind: ManagedArtifactKind.File,
      artifactType: ManagedArtifactType.LocalWorkflowNotes,
      privacy: ManagedPrivacy.Private,
      contentClass: ManagedContentClass.UserEditable,
      selectedProfiles: [LotusProfile.LocalFirst, LotusProfile.LinearFirst],
      selectedProcedures: workflowProcedures,
      migrationStrategy: MigrationStrategy.Frontmatter,
      includePackageTemplate: false,
      publicDocsAllowed: false,
    }),
    createArtifact({
      path: '.local/workflow.lotus.json',
      scope: ManagedArtifactScope.Local,
      kind: ManagedArtifactKind.File,
      artifactType: ManagedArtifactType.ProjectWorkflowConfig,
      privacy: ManagedPrivacy.Private,
      contentClass: ManagedContentClass.Generated,
      selectedProfiles: [LotusProfile.LocalFirst, LotusProfile.LinearFirst],
      selectedProcedures: workflowProcedures,
      migrationStrategy: MigrationStrategy.JsonManifest,
      includePackageTemplate: false,
      publicDocsAllowed: false,
    }),
    createArtifact({
