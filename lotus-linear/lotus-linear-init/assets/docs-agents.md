...
- `.docs/templates/` holds project-specific templates that may override bundled
  skill defaults only when they preserve required Linear source/link fields
...
- prefer durable project truth in `.docs/spec/` or `.docs/practices/`
- keep operational state in Linear, not in `.docs/`
