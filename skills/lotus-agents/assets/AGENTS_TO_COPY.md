...
When a reusable template exists, prefer the asset bundled with the relevant
installed skill over a `.local` snippet.
...
- `.local/pr-notes/<id>.md`: user-facing summary draft when release notes or PR
  notes matter
